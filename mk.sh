...
export ARCH=arm
export CROSS_COMPILE=/home/none/android/toolchains/prebuilts-gcc-linux-x86-arm-arm-eabi-4.6/bin/arm-eabi-
...
make VARIANT_DEFCONFIG=jf_att_defconfig SELINUX_DEFCONFIG=jfselinux_defconfig SELINUX_LOG_DEFCONFIG=jfselinux_log_defconfig jf_defconfig
